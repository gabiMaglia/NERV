...
- **Adversarial** (architecture-critical o 2º intento): después de Strong, una pasada hostil — asumí que está roto y buscá el fallo (race conditions, estados imposibles, supuestos del contrato). En architecture-critical esta pasada la corre nerv-arquitecto.
