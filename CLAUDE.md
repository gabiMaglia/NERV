...
| `.claude/agents/nerv-*.md` | Los 7 agentes (orquestador, arquitecto, backend, mobile, web, desktop, qa) — **fuente de verdad** |
...
5. **Modelos por agente** ya están en frontmatter: Opus (orquestador, arquitecto), Sonnet (backend, mobile, web, desktop, qa). No agregues `model:` arbitrariamente.
