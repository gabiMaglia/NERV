...
| `.claude/agents/nerv-*.md` | Los 8 agentes (orquestador, arquitecto, backend, mobile, web, desktop, qa, devops) — **fuente de verdad** |
...
5. **Modelos por agente** ya están en frontmatter: Opus (orquestador, arquitecto, devops), Sonnet (backend, mobile, web, desktop, qa). No agregues `model:` arbitrariamente.
